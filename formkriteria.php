...
<body>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="formkriteria.php">Input Kriteria</a></li>
    ...
    <div class="container">
        ...
        <form action="insertkriteria.php" method="POST">
            ...
            <label for="nmkriteria">Nama Kriteria:</label><br>
            <input type="text" id="nmkriteria" name="nmkriteria" required><br>
