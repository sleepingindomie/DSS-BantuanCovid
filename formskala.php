...
<body>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="formskala.php">Input Skala</a></li>
    ...
    <form action="insertskala.php" method="POST">
        ...
        <select id="value" name="value" required onchange="updateKeterangan(this.value)">
        ...
        <input type="text" id="keterangan" name="keterangan" required readonly><br>
...
<script>
    function updateKeterangan(value) {
        const keteranganField = document.getElementById('keterangan');

        // Menggunakan switch case untuk mengatur nilai keterangan berdasarkan value yang dipilih
        switch (value) {
            case '1':
                keteranganField.value = 'Sangat Rendah';
                break;
            case '2':
                keteranganField.value = 'Rendah';
                break;
            case '3':
                keteranganField.value = 'Sedang';
                break;
            case '4':
                keteranganField.value = 'Tinggi';
                break;
            case '5':
                keteranganField.value = 'Sangat Tinggi';
                break;
            default:
